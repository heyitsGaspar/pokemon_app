...
export const PageTitle = ({ name }: Props) => {
    ...
    return (
        <div className="flex flex-col items-center mb-8">
            <h1 className="text-4xl font-black tracking-widest text-center text-transparent uppercase bg-linear-to-r from-red-500 via-orange-400 to-red-600 bg-clip-text">
                {name}
            </h1>
            <div
